...
public class MenuViewController {
    ...
    private static final String PAGE_TYPE = "menu-management";

    @GetMapping
    public Result<List<Map<String, Object>>> list(
            @RequestParam(required = false, defaultValue = DEFAULT_USER_ID) String userId,
            @RequestParam(required = false, defaultValue = PAGE_TYPE) String pageType) {
        List<MenuView> views = menuViewService.listByUserIdAndPageType(userId, pageType);
